...
Invoke-WebRequest "https://download.microsoft.com/download/E/6/B/E6BFDC7A-5BCD-4C51-9912-635646DA801E/en-US/17.5.2.1/x64/msodbcsql.msi" -OutFile "C:\Users\Administrator\Downloads\msodbcsql.msi"
Start-Process "msiexec.exe" -Wait -ArgumentList '/quiet /passive /qn /i C:\Users\Administrator\Downloads\msodbcsql.msi IACCEPTMSODBCSQLLICENSETERMS=YES ADDLOCAL=ALL'  
