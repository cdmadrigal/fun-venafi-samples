...
Start-Process "msiexec.exe" -Wait -ArgumentList '/i C:\Users\Administrator\Downloads\rewrite_amd64.msi /q'
...
Start-Process "C:\Users\Administrator\Downloads\Venafi Trust Protection Platform 19.4.0\VenafiTPPInstallx64.msi" -Wait -ArgumentList '/q /n' 
