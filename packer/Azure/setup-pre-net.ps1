Invoke-WebRequest "https://aka.ms/vs/16/release/vc_redist.x64.exe" -OutFile "C:\Users\Public\Downloads\vc_redist.x64.exe"
Start-Process -FilePath "C:\Users\Public\Downloads\vc_redist.x64" -ArgumentList '/install /passive /norestart'
